...
String.prototype.wuiValidEmailFormat = function() {
	if (this == null || this == "") {
		...
		return /^\w[\w\-\.\~]*\@\w[\w\-\.]*\.\w{2,18}$/.test(this) && tld != null && this.wuiConstants.tlds.toLowerCase().split(",").indexOf(tld) > -1 ? true : false;
	}
};
...
String.prototype.wuiValidURLFormat = function() {
	if (this == null || this == "") {
		...
		return regexp.test(this) && tld != "" && this.wuiConstants.tlds.toLowerCase().split(",").indexOf(tld) > -1 ? true : false;
	}
};
