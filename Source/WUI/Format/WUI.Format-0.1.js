...
String.prototype.wuiValidEmailFormat = function() {
	if (this == null || this == "") {
		...
		return /^\w[\w\-\.\~]*\@\w[\w\-\.]*\.\w{2,18}$/.test(this) && tld != null && this.wuiConstants.tlds.toLowerCase().split(/\s+/).indexOf(tld) > -1 ? true : false;
	}
};
...
String.prototype.wuiValidURLFormat = function() {
	if (this == null || this == "") {
		...
		return regexp.test(this) && tld != "" && this.wuiConstants.tlds.toLowerCase().split(/\s+/).indexOf(tld) > -1 ? true : false;
	}
};
...
Date.prototype.wuiLoadNames = function() {
	if (this.wuiConstants.locales.toLowerCase().split(/\s+/).indexOf(this.wuiDefaults.locales.toLowerCase()) > -1) {
		let i;
		for (i=0; i<7; i++) {
