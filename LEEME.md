...
:root {
	...
	--wui-modal-bgcolor: rgba(1, 2, 3, .2); /* requiere formato RGBA */
	...
	--wui-table-column-sorter-asccolor-out: #444;
	--wui-table-column-sorter-asccolor-over: #000;
	--wui-table-column-sorter-asccolor-disabled: var(--app-disabledcolor);
	--wui-table-column-sorter-ascicon-src: none;
	--wui-table-column-sorter-desccolor-out: #444;
