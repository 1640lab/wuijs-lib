...
> [!IMPORTANT]
> Si se utiliza `js` como formato de los archivos de idioma, el archivo de idioma debe ser inicializado por la palabra reservada `return` seguido  de un objeto `{}`.
